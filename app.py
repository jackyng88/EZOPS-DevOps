...
def titanic(type):
    if type == 'reversed':
        ...
        return render_template('titanic_view.html',tables=[reversed_data.to_html(classes='females')],
               titles = ['Reversed'])
        ...
        return render_template('titanic_view.html',tables=[every_other_data.to_html()],
               titles = ['Every Other'])
